...
# -*- coding: utf-8 -*-
"""
PSGS-Drug single-pocket control generation script.

Use configuration files to run B1 or B2 target-order sensitivity controls.
...
def check_prior_service() -> bool:
    ...
    try:
        ...
        if PRIOR_MODE == "single_1":
            if not P1:
                print("[ERROR] single_1     prior_protein_path_1    ")
                return False
        elif PRIOR_MODE == "single_2":
            if not P2:
                print("[ERROR] single_2     prior_protein_path_2    ")
                return False
        else:
            if not P1 or not P2:
                print("[ERROR] dual     prior_protein_path_1 / prior_protein_path_2      ")
                return False
