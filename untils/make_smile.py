...
def zinc_data_with_bracket():
    ...
    f = open('E:\\graduate\\meeting\\mwx\\SFG-Drug-code\\SFG-Drug\\data\\250k_rndm_zinc_drugs_clean.smi', 'rb')
...
def zinc_data_with_bracket_original(file_dir):
    sen_space=[]
    #f = open('/Users/yang/smiles.csv', 'rb')
    #f = open('/home/terayama/molecule-design/ChemTS/data/250k_rndm_zinc_drugs_clean.smi', 'rb')
    f = open(file_dir, 'r')
    #f = open('/home/terayama/molecule-design/ChemTS/data/Enamine_HTScollection_1,691,374cpds_201601_wash_3D_canonical_unique.smi', 'rb')
